 ...
 *
 * Throws when Prettier fails (typically a parser error on malformed HTML).
 * The page compiler routes such failures through the
 * `formatOptions.parseError` policy on `PageCompilerOptions`.
